...
SELECT b.name AS ten_cong_trinh, h.name AS ten_chu_nhan, c.name AS ten_chu_thau
...
SELECT b.name AS ten_cong_trinh, a.name AS ten_kien_truc_su, (benefit * 1000) AS thu_lao
