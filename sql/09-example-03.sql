-- 01. Tìm tổng kinh phí của tất cả các công trình theo từng chủ thầu (là có nghĩa là id của chủ thầu)
...
-- 04. Tìm tổng số công nhân (worker_id) đã tham gia (work) ở mỗi công trình (building)
SELECT b.name AS ten_cong_trinh, COUNT(worker_id) AS tong_so_cong_nhan
